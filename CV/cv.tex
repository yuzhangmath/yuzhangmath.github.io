...
\begin{itemize}[wide=30pt, leftmargin=*]
    \item[] \textbf{Algebraic topology:}  classical and motivic homotopy theory computing the stable homotopy groups of spheres; model categories and higher category theory; higher structures of spaces and ring spectra.
\end{itemize}
